...
### --- Working Directory
wDir <- '/Users/fsmoura/Documents/R-files/OpenDataR-master/TrafficAccidentsBGD2015/'
setwd(wDir)
...
key<-"AIzaSyBA2Kt4jMYJe3up70J0Kl48Idrm69K6n0I"
register_google(key = key)
bgdMap <- get_map(location = 'Belgrade', maptype = "roadmap")
ggmap(bgdMap, 
      extent = "device") + 
